      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        ...
        >
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-xl border-2 border-border bg-card px-4 py-3 text-sm font-medium text-card-foreground transition-all hover:border-primary/30 hover:bg-accent"
          >
